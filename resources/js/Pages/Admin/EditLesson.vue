            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6">
                    ...
                    <form @submit.prevent="submit">
                        ...
                        <div class="flex items-center justify-end mt-6 relative z-10">
                            <button @click="submit" class="bg-primary text-white px-4 py-2 rounded-md cursor-pointer flex items-center gap-2"><i class="pi pi-check"></i>Update Lesson</button>
                        </div>
                    </form>
                </div>
            </div>
